...
function Login() {
    ...
    useEffect(() => {
        if (decodeURIComponent(searchParams.get('email')) !== 'null') {
            setUserDetails(prev => {
                return { ...prev, 'email': decodeURIComponent(searchParams.get('email')) }
            })
            setIncorrectDetails(true)
        }
        if (emailRef.current)
                ...
                <div className='login-signup-form-container'>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className={`login-signup-form-input ${emailAlert ? "login-signup-form-input-alert" : ""}`}>
                            <input ref={emailRef} onChange={handleInputs} placeholder='' value={userDetails.email} type="email" name="email" id='email' />
                        ...
                        <div className={`login-signup-form-input ${passwordAlert ? "login-signup-form-input-alert" : ""}`}>
                            <input ref={passwordRef} onChange={handleInputs} placeholder='' value={userDetails.password} type={showPassword ? "text" : "password"} name="password" id='password' />
                            <label htmlFor="password">Password</label>
                            <span onClick={() => setShowPassword(n => !n)}>{showPassword ? "Hide" : "Show"}</span>
